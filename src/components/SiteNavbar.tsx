...
const DEFAULT_PLATFORMS: NavPlatformDef[] = [
    ...
    { label: "Radium Performance", href: "/radium-performance" },
    { label: "Stooge Raceboards", href: "/stooge-raceboards" },
    { label: "Summerboard", href: "/summerboard" },
    { label: "Trampa Boards", href: "/trampa-boards" },
                ...
                if (data && data.length > 0 && isMounted) {
                    ...
                    alphabetic.forEach(p => {
                        ...
                        dynamicPlatforms.push({
                            label: p.name,
                            href: existingStatic ? existingStatic.href : `/${slug}`
                        } as NavPlatformDef);
                    });
