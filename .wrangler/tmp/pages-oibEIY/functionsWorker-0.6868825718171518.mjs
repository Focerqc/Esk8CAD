...
var onRequestGet = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    const getMeta = /* @__PURE__ */ __name((prop) => {
      const match2 = html.match(new RegExp(`<meta[^>]*property="${prop}"[^>]*content="([^"]*)"`, "i")) || html.match(new RegExp(`<meta[^>]*name="${prop}"[^>]*content="([^"]*)"`, "i"));
...
// ../.wrangler/tmp/pages-oibEIY/functionsRoutes-0.8572830526790909.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-YkW61o/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-YkW61o/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6868825718171518.mjs.map
